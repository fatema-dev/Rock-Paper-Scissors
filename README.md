...
1. **Open the Project:** Open the `index.html` file in any modern web browser (Edge, Chrome, Firefox) or Open the website via github Pages Link.
2. **Select an Option:** Select one of the choices : `rock`, `paper`, or `scissors`.
3. **Follow the Rounds:** Each Round Output is logged in the screen, you can also reset the game or view your score at any point during the game. 
